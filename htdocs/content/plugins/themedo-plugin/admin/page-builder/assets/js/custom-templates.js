...
( function ( $ ) {
	"use strict";
	$.themedoCustomTemplates = ( function () {
		
		var SaveTemplateHandler 	= $( '#avalon_td_save_custom_tpl' );
		var loadTemplateHanlder 	= $( '.avalon_td_load_template' );
		var deleteTemplateHanlder 	= $( '.avalon_td_delete_template' );
		...
		$( document ).ready( function () {
			...
			function checkIfTemplateExists ( tpl_name ) {
				...
				$('.avalon_td_custom_template').each(function(i, obj) {
					var name = $(obj).text();
			...
			function SaveCustomTemplate( ) {
				...
				var content = themedoParser.parseColumnOptions();
				//prepare data
				var data = {
						action	  : 'avalon_td_custom_tabs',
	...
	$(document).ready(function () {
		...
		$.themedoCustomTemplatesObj = new $.themedoCustomTemplates();
	});
