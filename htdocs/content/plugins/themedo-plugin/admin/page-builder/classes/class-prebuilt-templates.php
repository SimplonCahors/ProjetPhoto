...
if( ! class_exists( 'avalon_td_Core_Prebuilt_Templates' ) ) {

	class avalon_td_Core_Prebuilt_Templates {
			...
			if ( $templates != false && count( $templates ) > 0 ) {
				...
				for( $i = 0; $i < $columns; $i++) {
					...
					foreach( $templates as $key => $value ) {
						...
						$content.= ' <a class="avalon_td_pre_built_template templates_selection" data-id="'.$key.'" ';
