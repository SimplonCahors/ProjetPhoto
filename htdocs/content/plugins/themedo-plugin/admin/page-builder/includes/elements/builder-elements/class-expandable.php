 ...
 */
	class avalon_td_Expandable extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   		= 'expandable_box';
			// element name
			$this->config['name']	 		= __('Expandable', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_expandable">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Expandable', 'themedo-core').'</sub><div class="expandable_section">Expandable Box</div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name"	  		=> __('Content', 'themedo-core'),
							  "desc"	=> __('Enter the content to be displayed', 'themedo-core'),
