<?php
	 ...
	 */
	class avalon_td_GridOne extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'themedo-icon themedo-icon-grid-1';
			// css class related to this element
			$this->config['css_class'] = "avalon_td_layout_column grid_one item-container sort-container ";
			// tooltip that will be displyed upon mouse over the element
			//$this->config['tool_tip']  		= 'Creates a single (1/1) width column';
			...
			$this->config['data'] = array( "floated_width" => "1.00", "width" => "1/1", "drop_level" => "3" );
		}
		...
		//this function defines 1/1 sub elements or structure
