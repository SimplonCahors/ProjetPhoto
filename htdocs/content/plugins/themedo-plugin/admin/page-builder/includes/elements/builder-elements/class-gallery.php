 ...
 */
	class avalon_td_Gallery extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Gallery', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_gallery">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Gallery', 'themedo-core').'</sub><ul class="gallery_content"><li></li></ul></span></div>';
			$innerHtml .= '</div>';
	 	...
	 	$am_array = array();
	  	$am_array[] = array (
			...
			$this->config['subElements'] = array(
				...
				/*array(
					"name"  => __( 'Slide Type', 'themedo-core' ),
				...
				array(
					"name"  => __( 'Slide Autoplay', 'themedo-core' ),
				...
				/*array(
					"name"  => __( 'Slide Reverse', 'themedo-core' ),
				...
				array(
					"name"  => __( 'Slide Speed', 'themedo-core' ),
