 ...
 */
	class avalon_td_FlowGallery extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'flowgallery_box';
			// element name
			$this->config['name']	 		= __('Flow Gallery', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_flowgallery">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Flow Gallery', 'themedo-core').'</sub><ul class="gallery_content"><li></li></ul></span></div>';
			$innerHtml .= '</div>';
	 	...
	 	$am_array = array();
	  	$am_array[] = array (
			...
			$this->config['subElements'] = array(
				...
				array(
						"name" 			=> __('Enable/Disable Images Title', 'themedo-core'),
					  	"desc"			=> __('', 'themedo-core'),
					  	"id" 			=> "avalon_td_img_title",
					  	"type" 			=> ElementTypeEnum::SELECT,
					  	"value"	   		=> array('enable') ,
						"allowedValues" => array('enable' => __('Enable', 'themedo-core'),
												'disable' => __('Disable', 'themedo-core'))
