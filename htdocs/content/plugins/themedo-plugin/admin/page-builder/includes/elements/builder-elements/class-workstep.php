 ...
 */
	class avalon_td_WorkStep extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   			= 'workstep_box';
			// element name
			$this->config['name']	 		= __('Work Step', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_workstep">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Work Step', 'themedo-core').'</sub><p class="workstep_name">Workstep Title</p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Step', 'themedo-core'),
					  "desc"			=> __('Insert the step.', 'themedo-core'),
					  "id" 				=> "avalon_td_step",
				...
				array("name" 			=> __('Title', 'themedo-core'),
					  "desc"			=> __('Insert the title', 'themedo-core'),
					  "id" 				=> "avalon_td_title",
					  "type" 			=> ElementTypeEnum::INPUT,
					  "value" 			=> "" 
					  ),
