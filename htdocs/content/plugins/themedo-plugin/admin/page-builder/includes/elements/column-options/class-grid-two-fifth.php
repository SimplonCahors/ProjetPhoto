<?php
	 ...
	 */
	class avalon_td_GridTwoFifth extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'themedo-icon themedo-icon-grid-2-5';
			// css class related to this element
			$this->config['css_class'] = "avalon_td_layout_column grid_two_fifth item-container sort-container ";
