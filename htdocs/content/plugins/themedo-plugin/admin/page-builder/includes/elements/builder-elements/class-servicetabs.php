 ...
 */
	class avalon_td_Servicetabs extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Servicetabs', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_servicetabs">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Service Tabs', 'themedo-core').'</sub><p class="servicetabs_content">content goes here</p></span></div>';
			$innerHtml .= '</div>';
	 	...
	 	$am_array = array();
	  	$am_array[] = array (  	  
							array(		"name"		=> __('Title', 'themedo-core'),
										"desc"		=> __('Insert the title of the tab', 'themedo-core'),
										"id"		=> "title[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   	=> array("") 
							),
							array(		"name"		=> __('Image', 'themedo-core'),
										"desc"		=> __('Insert the image of the tab', 'themedo-core'),
										"id"		=> "image[0]",
							...
							array(		"name"		=> __('Link', 'themedo-core'),
						  	...
						  	array( 		"name"	 	=> __('Servicetab Content', 'themedo-core'),
										"desc"		=> __('Add the servicetab content', 'themedo-core'),
			...
			$this->config['subElements'] = array(
				...
				array("type" 			=> ElementTypeEnum::ADDMORE,
					  "buttonText"		=> __('Add New Tab', 'themedo-core'),
					  "id"				=> "am_avalon_td_servicetab",
					  "elements" 		=> $am_array
					  ),
				);
		}
