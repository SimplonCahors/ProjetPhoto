<?php
	 ...
	 */
	class avalon_td_GridSix extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'themedo-icon themedo-icon-grid-6';
			// css class related to this element
			$this->config['css_class'] = "avalon_td_layout_column grid_six item-container sort-container ";
