 ...
 */
	class avalon_td_TDContent extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   		= 'tdcontent_box';
			// element name
			$this->config['name']	 		= __('Content Box', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_tdcontentbox">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Content Box', 'themedo-core').'</sub></span></div>';
			$innerHtml .= '</div>';
