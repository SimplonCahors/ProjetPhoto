 ...
 */
	class avalon_td_Accordion extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id']	   		= 'accordion_box';
			// element name
			$this->config['name']	 		= __('Accordion', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_Accordion">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Accordion', 'themedo-core').'</sub><ul class="toggles_content"><li>Toggle title here</li><li>Toggle title here</li><li>Toggle title here</li></ul></span></div>';
			$innerHtml .= '</div>';
	  ...
	  $am_array[] = array ( 
							array( "name"	 		=> __('Title', 'themedo-core'),
										"desc"		=> __('Insert the accordion title', 'themedo-core'),
										"id"		=> "avalon_td_title[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   	=> array()
							),
						  array( "name"	 			=> __('Open by Default', 'themedo-core'),
										"desc"		=> __('Choose to have the accordion open when page loads', 'themedo-core'),
										"id"		=> "avalon_td_open[0]",
										"type"		=> ElementTypeEnum::SELECT,
										"value"	   	=> array('no') ,
									  	"allowedValues"   => array('no'	 => __('No', 'themedo-core'),
																'yes'	 => __('Yes', 'themedo-core'))
							),
						  array( "name"	 			=> __('Accordion Content', 'themedo-core'),
										"desc"		=> __('Insert the accordion content', 'themedo-core'),
