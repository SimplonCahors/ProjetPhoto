<?php
	 ...
	 */
	class avalon_td_GridThree extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'themedo-icon themedo-icon-grid-3';
			// element icon
			$this->config['icon_url'] = "icons/sc-three.png";
			// css class related to this element
			$this->config['css_class'] = "avalon_td_layout_column grid_three item-container sort-container ";
