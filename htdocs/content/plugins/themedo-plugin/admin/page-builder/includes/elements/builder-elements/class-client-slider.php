 ...
 */
	class avalon_td_ClientSlider extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Client Slider', 'themedo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "avalon_td_element_box";
			// element icon class
			$this->config['icon_class']		= 'themedo-icon builder-options-icon themedoa-users';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_client_slider">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-users"></i><sub class="sub">'.__('Client Slider', 'themedo-core').'</sub><ul class="client_slider_elements"><li></li></ul></span></div>';
			$innerHtml .= '</div>';
	  ...
	  $am_array[] = array ( 
							array( "name"	 => __('Client Website Link', 'themedo-core'),
										"desc"		=> __('Add the url to client\'s website <br>ex: http://example.com', 'themedo-core'),
										"id"		=> "avalon_td_url[0]",
						  ...
						  array("name"	=> __('Client Image', 'themedo-core'),
									  "desc"		=> __('Upload the client image', 'themedo-core'),
			...
			$this->config['subElements'] = array(
			   ...
			   array("type" 			=> ElementTypeEnum::ADDMORE,
					  "buttonText"		=> __('Add New Client Image', 'themedo-core'),
					  "id"				=> "am_avalon_td_client",
					  "elements" 		=> $am_array
					  ),
				);
		}
