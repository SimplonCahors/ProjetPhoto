 ...
 */
	class avalon_td_Tabs extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Tabs', 'themedo-core');
			// element icon
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_tabs">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-expand-alt"></i><sub class="sub">'.__('Tabs', 'themedo-core').'</sub><ul class="tabs_elements"><li>tab title 1 here</li><li>tab, title 2 here</li><li>tab title 3 here</li></ul></span></div>';
			$innerHtml .= '</div>';
	 ...
	 $am_array = array();
	  $am_array[] = array ( 
							array("name"	=> __('Tab Title', 'themedo-core'),
										"desc"		=> __('Title of the tab', 'themedo-core'),
										"id"		=> "avalon_td_title[0]",
										"type"		=> ElementTypeEnum::INPUT,
										"value"	   => array("") 
							),							
						  	array( "name"	 => __('Tab Content', 'themedo-core'),
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('Horizontal Position', 'themedo-core'),
					  //"desc" 			=> __('Choose the layout of the shortcode', 'themedo-core'),
