 ...
 */
	class avalon_td_SoundCloud extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element name
			$this->config['name']	 		= __('Soundcloud', 'themedo-core');
			// element icon
			$this->config['icon_url']  		= "icons/sc-text_block.png";
			// css class related to this element
			$this->config['css_class'] 		= "avalon_td_element_box";
			// element icon class
			$this->config['icon_class']		= 'themedo-icon builder-options-icon themedoa-soundcloud';
		...
		public function create_visual_editor( $params ) {
			...
			$innerHtml  = '<div class="avalon_td_iconbox textblock_element textblock_element_style" id="avalon_td_soundcloud">';
			$innerHtml .= '<div class="bilder_icon_container"><span class="avalon_td_iconbox_icon"><i class="themedoa-soundcloud"></i><sub class="sub">'.__('Soundcloud', 'themedo-core').'</sub><p class="soundcloud_url">Soundcloud URL here</p></span></div>';
			$innerHtml .= '</div>';
		...
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array("name" 			=> __('SoundCloud Url', 'themedo-core'),
				...
				array("name" 			=> __('Show Comments', 'themedo-core'),
					  "desc" 			=> __('Choose to display comments.', 'themedo-core'),
					  "id" 				=> "avalon_td_comments",
					  "type" 			=> ElementTypeEnum::SELECT,
					  "value" 			=> "yes",
					  "allowedValues" 	=> $choices 
					  ),
					  
				array("name" 			=> __('Show Related', 'themedo-core'),
					  "desc" 			=> __('Choose to display related items.', 'themedo-core'),
					  "id" 				=> "avalon_td_related",
					  "type" 			=> ElementTypeEnum::SELECT,
					  "value" 			=> "yes",
					  "allowedValues" 	=> $choices 
					  ),
					  
				array("name" 			=> __('Show User', 'themedo-core'),
