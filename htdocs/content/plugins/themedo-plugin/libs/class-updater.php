<?php
if( ! class_exists( 'themedoCoreUpdater' ) ) {
	class themedoCoreUpdater {
		var $api_url;
		var $id;
		var $slug;
		...
		function __construct( $api_url, $id, $slug ) {
			...
			/*if( get_option( 'avalon_td_'. $this->slug .'_update_available' ) ){
				add_action( 'admin_notices', array(&$this, 'update_notice') );
			}*/
		}
		
		function check_for_update( $transient ) {
			global $wp_filesystem, $avalon_td_option;
			...
			$request_args['envato_username'] = $avalon_td_option['avalon_td_username'];
			$request_args['api_key'] = $avalon_td_option['avalon_td_api'];
