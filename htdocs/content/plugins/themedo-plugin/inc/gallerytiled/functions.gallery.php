...
class themePacific_Jetpack_Gallery_Settings {
	...
	function admin_init() {
		$this->gallery_types = apply_filters( 'jetpack_gallery_types', array( 'default' => __( 'Thumbnail Grid', 'themedo-core' ) ) );
	...
	function wp_enqueue_media() {
		...
		/*wp_register_script('themedo-gallery-settings', get_template_directory_uri() . '/inc/gallerytiled/gallery-settings.js', 'jquery', '1.0', TRUE);
		wp_enqueue_script( 'themedo-gallery-settings' );*/
	}
	...
	function print_media_templates() {
		...
		<script type="text/html" id="tmpl-jetpack-gallery-settings">
			<label class="setting">
				<span><?php _e( 'Type', 'themedo-core' ); ?></span>
