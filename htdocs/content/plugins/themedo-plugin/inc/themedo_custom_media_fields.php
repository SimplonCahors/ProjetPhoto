...
$attchments_options = array(
    'image_purchase_url' => array(
        'label'       => __( 'Purchase Url', 'avalon' ),
        'input'       => 'text',
        //'helps'       => __( 'Add url to purchase the image', 'avalon' ),
        'application' => 'image',
        'exclusions'  => array( 'audio', 'video' ),
    ),
	'image_video_url' => array(
        'label'       => __( 'External Video Url', 'avalon' ),
        'input'       => 'text',
        'helps'       => __( 'Url from Youtube or Vimeo', 'avalon' ),
        'application' => 'image',
        'exclusions'  => array( 'audio', 'video' ),
    ),
...
class Avalon_Custom_Media_Fields {
...
$cmf = new Avalon_Custom_Media_Fields( $attchments_options );
