...
class themedoSC_TwoThird {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_two-third-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_two-third-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s>%s</div>%s', themedoCore_Plugin::attributes( 'two-third-shortcode' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'td-col-8 themedo-layout-column';
