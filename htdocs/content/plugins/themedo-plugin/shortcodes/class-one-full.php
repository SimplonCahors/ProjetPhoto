...
class themedoSC_OneFull {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_one-full-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$styles .= '.avalon_td_col_12_' . $this->avalon_td_counter . '{
		...
		$html = sprintf( '<div %s>%s</div>%s', themedoCore_Plugin::attributes( 'one-full-shortcode' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'td-col-12 themedo-layout-column avalon_td_col_12_' . $this->avalon_td_counter . '';
