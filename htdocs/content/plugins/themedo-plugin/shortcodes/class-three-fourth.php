...
class themedoSC_ThreeFourth {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_three-fourth-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_three-fourth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s>%s</div>%s', themedoCore_Plugin::attributes( 'three-fourth-shortcode' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'td-col-9 themedo-layout-column';
