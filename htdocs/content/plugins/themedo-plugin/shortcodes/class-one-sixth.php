...
class themedoSC_OneSixth {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_one-sixth-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_one-sixth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', themedoCore_Plugin::attributes( 'one-sixth-shortcode' ), themedoCore_Plugin::attributes( 'one-sixth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'themedo-one-sixth themedo-layout-column';
