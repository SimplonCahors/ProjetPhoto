...
class themedoSC_OneFifth {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_one-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_one-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', themedoCore_Plugin::attributes( 'one-fifth-shortcode' ), themedoCore_Plugin::attributes( 'one-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'themedo-one-fifth themedo-layout-column';
