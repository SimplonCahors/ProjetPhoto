...
class themedoSC_OneHalf {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_one-half-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s>%s</div>%s', themedoCore_Plugin::attributes( 'one-half-shortcode' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'td-col-6 themedo-layout-column';
