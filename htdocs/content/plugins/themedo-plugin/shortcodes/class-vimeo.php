...
class themedoSC_Vimeo {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_vimeo-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_vimeo-shortcode-video-sc', array( $this, 'video_sc_attr' ) );
	...
	function render( $args, $content = '' ) {
		...
		$html = sprintf( '<div %s><div %s><iframe src="%ss://player.vimeo.com/video/%s?autoplay=0%s" width="%s" height="%s" frameborder="0"></iframe></div></div>',
						 themedoCore_Plugin::attributes( 'vimeo-shortcode' ), themedoCore_Plugin::attributes( 'vimeo-shortcode-video-sc' ), $protocol, $id, $api_params, $width, $height );
	...
	function attr() {
		...
		$attr['class'] = 'themedo-video themedo-vimeo';
