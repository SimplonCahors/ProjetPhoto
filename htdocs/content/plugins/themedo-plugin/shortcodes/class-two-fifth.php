...
class themedoSC_TwoFifth {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_two-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_two-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', themedoCore_Plugin::attributes( 'two-fifth-shortcode' ), themedoCore_Plugin::attributes( 'two-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'themedo-two-fifth themedo-layout-column';
