...
class themedoSC_FontAwesome {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_fontawesome-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$defaults['font_size'] = avalon_td_strip_unit( self::convert_deprecated_sizes( $defaults['size'] ) );
		...
		$html = sprintf( '<i %s>%s</i>', themedoCore_Plugin::attributes( 'fontawesome-shortcode' ), do_shortcode( $content ) );
	...
	function attr() {
		...
		$attr['class'] = sprintf( 'fa fontawesome-icon %s circle-%s', themedoCore_Plugin::font_awesome_name_handler( self::$args['icon'] ), self::$args['circle'] );
		$attr['style'] = '';
