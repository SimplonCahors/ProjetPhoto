...
class themedoSC_FourFifth {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_four-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'avalon_td_attr_four-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', themedoCore_Plugin::attributes( 'four-fifth-shortcode' ), themedoCore_Plugin::attributes( 'four-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'themedo-four-fifth themedo-layout-column';
