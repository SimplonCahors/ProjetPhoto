...
class themedoSC_OneThird {
	...
	public function __construct() {
		...
		add_filter( 'avalon_td_attr_one-third-shortcode', array( $this, 'attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s>%s</div>%s', themedoCore_Plugin::attributes( 'one-third-shortcode' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'td-col-4 one_third themedo-layout-column';
